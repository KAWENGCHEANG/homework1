...
<table border="0" width="<?=$form_size ;?>"> 
  ...
  <tr> 
    ...
    <td width="23%" align="center" bgcolor="<?=$menu_bgcolor;?>" style="border: <?=$form_line;?> <?=$form_type;?> <?=$form_color;?>"><font color="<?=$menu_font;?>" size="2">Teacher</font></td> 
  </tr> 
<?
# 用for迴圈來讀取公告筆數
for($i=0;$i<$count;$i++){
...
?>
  ...
  <tr> 
    <td width="100%" align="center" bgcolor="<?=$login_bgcolor;?>" style="border: <?=$form_line;?> <?=$form_type;?> <?=$form_color;?>" colspan="4"><a href="login.php"><font size="1" color="<?=$login_font;?>" face="Verdana"><img src="img/admin.gif" border="0">Edit</font></a></td> 
  </tr> 
  <tr> 
    <td width="100%" align="center" bgcolor="<?=$cooltey_bgcolor;?>" style="border: <?=$form_line;?> <?=$form_type;?> <?=$form_color;?>" colspan="4"><font size="1" face="Verdana" font="<?=$cooltey_font;?>"> v4.5 Powered By <a href="http://www.cooltey.org">Cooltey</a> 
      </font></td> 
  </tr> 
</table> 
</center> 
