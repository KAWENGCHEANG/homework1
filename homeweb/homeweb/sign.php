...
$sign_name="taipap" ;//←主使用者
$sign_passwd="taipap28837222" ;//←主使用者密碼

$sign_name_1="teacher" ;//←次級使用者帳號1
$sign_passwd_1="teacher2015" ;//←次級使用者密碼1

$sign_name_2="tai" ;//←次級使用者帳號2
$sign_passwd_2="tai28837222" ;//←次級使用者密碼2

$sign_name_3="pap" ;//←次級使用者帳號3
$sign_passwd_3="pap28837222" ;//←次級使用者密碼3
