...
# 下面都是判斷傳送的值中是否是空值
if(@$_POST['title']==""){
echo "<table border=0 width=150><tr><td><fieldset><center><br><font color=Red size=2><legend>Forget write Title！</legend></font><a href=javascript:history.back(1)><font color=$font_link size=2>回上一頁</font></a></fieldset></td></tr></table>";
exit;
}
if(@$_POST['name']==""){
echo "<table border=0 width=150><tr><td><fieldset><center><br><font color=Red size=2><legend>Forget write name！</legend></font><a href=javascript:history.back(1)><font color=$font_link size=2>回上一頁</font></a></fieldset></td></tr></table>";
exit;
}
if(@$_POST['note']==""){
...
# 關閉sub.dat
fclose($f);
echo "<table border=0 width=150><tr><td><fieldset><center><br><font color=Red size=2><legend>Success</legend></font><a href=javascript:history.back(1)><font color=$font_link size=2>Black</font></a><hr color=$menu_bgcolor width=150 size=1><a href=sub.php><font color=$font_link size=2>Black home</font></a></fieldset></td></tr></table>";
}
