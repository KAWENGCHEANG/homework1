...
# 判斷$editid的值
if(@$_POST['editid']==""){  
echo"<font color=Red size=2><center>Edit the document</font>"; 
}else{ 
# 取得需要更新的公告ID
...
# 排序好要存取的檔案，用∥來分別
	...
	$new_sub=$kind."∥".$t."∥".$title."∥".$url."∥".$name."∥".$mail."∥".$updname."∥".$hidden."∥".$note."\n";
        ...
        if($edit_open = fopen($edit_file, "w+")){ 
 		...
 		echo"<font color=Red size=2><center>Success！</font><br>"; 
...
<table border="0" width="<?=$form_size;?>">   
  <tr>   
    <td width="102%" colspan="4" style="border: <?=$form_line;?> <?=$form_type;?> <?=$form_color;?>" bgcolor="<?=$title_bgcolor;?>">   
      <p align="center"><font size="2" color="<?=$title_font;?>">Announcement</font><font color="<?=$title_font;?>" size="2"> from user </font></td>   
  </tr>   
  <tr>   
    <td width="25%" align="center" bgcolor="<?=$menu_bgcolor;?>" style="border: <?=$form_line;?> <?=$form_type;?> <?=$form_color;?>"><font size="2" color="<?=$menu_font;?>">Title of the announcement:</font></td>   
    ...
    <tr>   
    <td width="20%" align="center" bgcolor="<?=$menu_bgcolor;?>" style="border: <?=$form_line;?> <?=$form_type;?> <?=$form_color;?>"><font size="2" color="<?=$menu_font;?>">Name of the administrator:</font></td>   
    ...
    <td width="20%" align="center" bgcolor="<?=$menu_bgcolor;?>" style="border: <?=$form_line;?> <?=$form_type;?> <?=$form_color;?>"><font size="2" color="<?=$menu_font;?>">E-mail address of the administrator ：</font></td>  
...
<center>      
  ...
  <tr>       
    <td width="25%" align="center" bgcolor="<?=$menu_bgcolor;?>" style="border: <?=$form_line;?> <?=$form_type;?> <?=$form_color;?>"><font size="2" color="<?=$menu_font;?>">Time:</font></td>       
    <td width="77%" align="center" bgcolor="<?=$explor_bgcolor;?>" style="border: <?=$form_line;?> <?=$form_type;?> <?=$form_color;?>" colspan="3"><font face="v" size="2" color="<?=$explor_font;?>"><input type="radio" name="date_option" value="1" checked>
    <font color="<?=$menu_font;?>">Use the saved time:</font><?=$date;?><br>
    <input type="radio" name="date_option" value="2">
    <font color="<?=$menu_font;?>">Use the current time </font><font color="<?=$menu_font;?>">:</font><?=date("Y/m/d");?></font>
